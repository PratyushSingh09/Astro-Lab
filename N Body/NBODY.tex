...
\end{equation}
At distances greater than $\Delta_c$, the system is considered to be stable. 
...
Kirkwood gaps are caused by the resonant interaction between the asteroids and Jupiter \ref{asteroids}. The resonant interaction leads to the instability of the orbits of the asteroids.
