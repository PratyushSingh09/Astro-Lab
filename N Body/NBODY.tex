...
In this part of the lab work we simulate 10000 inactive bodies at semi-major axis range $[2, 4] AU$ along with Sun-Jupiter-Mars system to observe the distribution of these objects over time. Our goal is to observe Kirkwood gaps - gaps in the asteroid belt. These gaps apprear due to the orbital resonance with Jupiter.
